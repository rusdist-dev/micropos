{{-- Modal input jasa servis. Membaca scope Alpine induk (create order servis). --}}
<x-ui.modal title="Tambah Jasa" size="md" show="showService">
    <div class="space-y-4">
        <div>
            ...
            <input type="text" x-model="serviceForm.name" placeholder="cth. Servis Mainboard"
    ...
    <x-slot:footer>
        ...
        <x-ui.button type="button" icon="plus" @click="addService()"
            ::disabled="! serviceForm.name || serviceForm.price === ''">Tambah</x-ui.button>
    </x-slot:footer>
</x-ui.modal>
